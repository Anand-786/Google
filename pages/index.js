    ...
    <div className='flex flex-col items-center justify-center h-screen'>
      ...
      <header className='flex w-full p-5 justify-between text-sm text-gray-700'>
        ...
        <div className='flex space-x-4 items-center'>
          ...
          {/* Icon */}
          <ViewGridIcon className='w-10 h-10 p-2 rounded-full 
        ...
        <form className='flex flex-col items-center mt-20 flex-grow w-4/5'>
          ...
          rounded-full border border-gray-200 px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl justify-center'>
            <SearchIcon className='pl-3 h-5 mr-3 text-gray-500 shrink-0' />
            <input ref={searchInputRef} type='text' className='focus:outline-none flex-grow' />
            <MicrophoneIcon className='pr-3 h-5 cursor-pointer shrink-0' />
          </div>
